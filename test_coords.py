...
group_names = ['bPic', 'TW Hya', 'AB Dor', 'Carina']
star_names = ['bPic', 'TW Hya', 'AB Dor', 'HIP 32235']
xyzuvw_group_all = np.array([[9.27,-5.96,-13.59,-10.94,-16.25,-9.27],\
    [12.49, -42.28, 21.55, -9.95, -17.91, -4.65],\
    [-2.37, 1.48, -15.62, -7.12, -27.31, -13.81],\
    [15.55, -58.53, -22.95, -10.34, -22.31, -5.91]])
star_radecpipmrv_all = [[86.82, -51.067, 51.44, 4.65, 83.1, 20], \
