...
save_file_name = '../results/tables/bpmg_members_complete_astro_table.tex'

# rdir = '../results/em_fit/beta_Pictoris_with_gaia_small_1.0/3/A/final/'
# z_file = rdir + 'final_membership.npy'

table_file = '../data/beta_Pictoris_with_gaia_small_everything.fits'
...
with open(save_file_name, 'w') as fp:
    ...
    for ix, row in enumerate(sub_table):
