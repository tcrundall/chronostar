...
/*
 *  A simple helper function to display the contents of a 2-D matrix
 */
...
/*
 *  A simple helper function to display the contennts of a 1-D vector
 */
