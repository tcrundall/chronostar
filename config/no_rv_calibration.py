...
config = {
    ...
    # 'data_loadfile': '../data/no_rv_paper/beta_Pictoris_with_gaia_small_everything_final_big_fake_rv_errors_from_gaia.fits', # CHANGE RV UNCERTAINTIES HERE
    'data_loadfile': '../data/no_rv_paper/bpmg_run_subset_fake_rv_errors.fits', # C
    #'data_loadfile': '../data/no_rv_paper/bpmg_run_subset.fits', # C
    'data_savefile': '../results/{}/beta_Pictoris_with_background_dummy.fits'.format(assoc_name), #,#''../results/{}/{}_subset.fit'.format(assoc_name, assoc_name), # Chronostar adds XYZUVW columns and
