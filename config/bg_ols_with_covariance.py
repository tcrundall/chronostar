...
assoc_name = ''
prefix = 'marusa_bg_ols_small_errors'
config = {
    # 'datafile':'',
    'results_dir':'../results/{}'.format(prefix),
    #'data_loadfile':'../data/gaia_cartesian_full_6d_table.fits',
    #'data_loadfile': '../data/synth_data_for_marusa_from_paper_1/same_centroid_synth_measurements_infinite_errors.fits', # every 3rd star had a big error
