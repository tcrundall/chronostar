...
config = {
    ...
    'data_loadfile': '',
    'data_savefile': '../results/{}/{}.fits'.format(prefix, prefix), #,#''../results/{}/{}_subset.fit'.format(assoc_name, assoc_name), # Chronostar adds XYZUVW columns and
                                        # if you don't want to override the original file then save into data_savefile.
    'plot_it':False, # What kind of plots?
