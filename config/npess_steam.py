...
assoc_name = ''
prefix = 'npess_stream_tims'
config = {
    # 'datafile':'',
    'results_dir':'../results/{}'.format(prefix),
    'data_loadfile': '../data/npess_stream_full_astrometry.fits',
    'data_savefile': '../data/npess_stream_full_cartesian.fits', #,#''../results/{}/{}_subset.fit'.format(assoc_name, assoc_name), # Chronostar adds XYZUVW columns and
